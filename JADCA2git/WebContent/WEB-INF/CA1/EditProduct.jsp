...
<body style="background: #27282E">
    ...
    ||(Boolean)session.getAttribute("role").equals("customer")){
...
Back</a></h1>
	...
	%>
		<h1 class=backButton><a href="RootPage.jsp" style="color:white; text-decoration:none;">
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
width="26" height="26" viewBox="0 0 172 172"style=" fill:#000000;">
<g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M70.08173,86l56.79928,-57.98798c2.53245,-2.58413 2.50661,-6.71875 -0.05169,-9.30288l-10.15565,-10.15565c-2.60997,-2.58413 -6.79628,-2.58413 -9.38041,0.02584l-72.27824,72.74339c-1.29207,1.29206 -1.9381,2.97176 -1.9381,4.67728c0,1.70553 0.64603,3.38522 1.9381,4.67728l72.27824,72.74339c2.58413,2.60997 6.77044,2.60997 9.38041,0.02584l10.15565,-10.15565c2.55829,-2.58413 2.58413,-6.71875 0.05169,-9.30288z"></path></g></g></svg>
Back</a></h1>
	...
	String[] Product = getProductInfo(out, itemid);
	session.setAttribute("itemId",Product[7]);
	%>
			...
			<form action="EditProductLogic.jsp" method="post">
				...
				<div class="txtb">
					<label>Detailed description :</label> <input type="text"
						name="DetailDescription" value="<%out.print(Product[2]);%>"
				...
				<div class="txtb">
					<label>Cost price :</label> <input type="number" name="Price"
						value="<%out.print(Product[3]);%>" min=0
				...
				<div class="txtb">
					<label>Stock quantity :</label> <input type="number" name="stock"
						value="<%out.print(Product[4]);%>" min=0
				...
				<div class="txtb">
					<label>Image location :</label> <input type="text"
						name="image" placeholder="Enter an image" value=<%=Product[6] %> required>
				</div>
				<input class="btn" type="submit" value="Update product">
				
			</form>
			<form action="deleteProduct.jsp?">
			<input type = hidden name = itemId value = <%=Product[7] %>>
