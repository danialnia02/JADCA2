...
<body style="background: #27282E">
	...
	try {
		if (userData.getRole() == null || !userData.getRole().equals("admin")) {
	...
	ResultSet HeaderSql = (ResultSet) request.getAttribute("HeadersSql");
	...
	<section>
		...
		<div class="contact-form">
			<form action="addProductLogic.jsp" method="post">
				...
				<div class="txtb">
					<%
						GetCategories(out, HeaderSql);
					%>
				</div>

				<div class="txtb">
					<label>Stock quantity :</label> <input type="number" name="stock"
						min=0 placeholder="Enter the stock quantity" required>
				</div>
...
<%!public void GetCategories(JspWriter out, ResultSet rs) throws java.io.IOException {
		...
		try {
			...
			System.out.println("error in addproduct get categories");
			e.printStackTrace();
		}
	}%>
<style>
